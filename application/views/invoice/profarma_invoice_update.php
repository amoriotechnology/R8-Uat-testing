                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" tabindex="3" class="form-control" id="chalan_no" name="chalan_no"  value="{chalan_no}"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><span class='form-control' style='background-color: #eee;'><?php echo $currency;  ?>
                                            <input type="text" id="Total"  name="total" value="<?php echo $purchase_info[0]['gtotal'];  ?>" readonly="readonly" />
                                 </span>   </td>
